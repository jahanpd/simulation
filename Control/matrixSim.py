...
def population(popSize, Plane, predCurve):
    rateGene1 = np.random.randint(1, high=600, size=(popSize, 1))
    rateGene2 = np.random.randint(1, high=600, size=(popSize, 1))
...
for run in range(iterations):
    ...
    rateStd1 = []
    organismMoveRate1 = 1
    predCurve1 = 1.03  # larger number is harsher
    predationRate1 = 0.8
    ...
    organismMoveRate2 = 1
    predationRate2 = 0.8
    predCurve2 = 1.03  # larger predCurves mean harsher predation curves
